...
include '../incorporate/activate_start.php';
...
$canId = decrypt($decrip, ENCRYPTION_KEY);
$canId = trim($canId);

if(isActivated($canId)){
...
<!--[if (gte IE 9)|!(IE)]><!--> <html lang="en"> <!--<![endif]-->
  ...
  <body class="sign-in-up" id="to-top">
        ...
        <section class="sign-in-up-content">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <input class="form-control" id="d" name="d" type="hidden" value="<?php echo htmlentities($canId);?>">

                <!-- Input 1 -->
                <div class="form-group">
                  <input class="form-control input-activate" id="email-activate" name="email" type="email" placeholder="Correo Electrónico">
                </div> <!-- /.form-group -->

                <!-- Input 2 -->
                <div class="form-group">
                  <input class="form-control input-activate" id="password-activate" name="password" type="password" placeholder="Contraseña">
                </div> <!-- /.form-group -->

                <!-- Button -->
                 <button class="btn btn-success btn-block" id="goActivate" type="submit" name="btn_acepto" onclick="formActivate(this.form, this.form.email, this.form.password, this.form.d);">Activar</button>
                ...
                <section class="sign-in-up-links text-center" style="font-size:14px">
                  <p><a href="./forgot-password.php">¿Olvidaste Password?</p>
    ...
    <script>
      //ROOM
      $('button#goActivate').attr('disabled', true);
    </script>
    ...
    //METHODS
      var formMethod = {
        fillingControl : function () {
          ...
          $('button#goActivate').attr('disabled', !isFull);
        },
    ...
    <script>
      ...
      $(document).ready(function() {
        $('input.input-activate').on('keyup', formMethod.keyupInput);
        $('button#goActivate').on('click', formMethod.clickGo);
      });
    </script>
